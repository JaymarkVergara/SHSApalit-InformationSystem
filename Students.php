        ...
        <thead>
            ...
            <?php do{ ?>
                <tr class="acourse-td">
                    ...
                    <Td><a href="viewstudents.php?ID=<?php echo $row['id']; ?>">View</a></Td>
                    <Td><a href="addstudents.php">Add</a></Td>
                    <Td><a class="form-a" href="studentedit.php?ID=<?php echo $row['id']; ?>">Edit</a></Td>
